...
void SERVO_Init(uint16_t au16_SERVO_Instance)
{
    ...
    gs_SERVO_info[au16_SERVO_Instance].CCR_Min = (uint16_t) (ARR_Value * (SERVO_CfgParam[au16_SERVO_Instance].MinPulse/3.0));
    gs_SERVO_info[au16_SERVO_Instance].CCR_Max = (uint16_t) (ARR_Value * (SERVO_CfgParam[au16_SERVO_Instance].MaxPulse / 3.0));
